    ...
    for i in range(epoch):
        ...
        if local_rank == 0:
            if (i + 1) % log_print_interval_epoch == 0:
                ...
                writer.add_scalar("Test Metric", test_metric,i+1)
                writer.add_scalar("Test Side1 Metric", test_side1_metric,i+1)
                writer.add_scalar("Test Side2 Metric", test_side2_metric,i+1)
