...
class Physics_Attention_1D_Eidetic(nn.Module):
    ...
    def forward(self, x):
        ...
        # consider this is the sum of the weights on each GPU
        slice_norm = slice_weights.sum(2)  # B H G
        
        # consider this is the sum of the weights on all GPUs
        # Only use all_reduce if distributed training is initialized
