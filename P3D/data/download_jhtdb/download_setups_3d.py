...
def get_setup(name, **kwargs)-> Tuple[dict, dict, str]:
    if name == "channel":
        return get_channel(**kwargs)
    elif name == "isotropic1024coarse":
        return get_isotropic1024coarse(**kwargs)
    elif name == "mhd1024":
        return get_mhd1024(**kwargs)
    elif name == "transition_bl":
        return get_transition_bl(**kwargs)
    else:
...
def get_isotropic1024coarse(temporal_start=1,
                            temporal_end=5000,
                            spatial_end=None):

    if spatial_end is None:
        spatial_end = [512, 512, 512]
